...
$Credential = Get-SecretCredential -Name "\\$Env:HaServerName" -Username="$UserName"
Get-DriveOrCreate -RootPath "\\$HaServerName\config" -Credential $Credential -Persist:$false
