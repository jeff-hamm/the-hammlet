...
//   At: 2025-02-09T17:22:16.1432562-08:00
//
...
public partial class WakeWordEntities : IEntityDomain<WakeWordEntity>
{
    ...
    public WakeWordEntity Entity(string entityId)
    {
        return (WakeWordEntity)_haContext.Entity(entityId);
    }

    ///<summary>openwakeword</summary>
    public WakeWordEntity Openwakeword => new(_haContext, "wake_word.openwakeword");
    public WakeWordIds Ids => new();
}