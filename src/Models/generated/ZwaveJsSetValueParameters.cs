...
//   At: 2025-02-03T13:48:14.4737330-08:00
//
...
public partial record ZwaveJsSetValueParameters
{
    ...
    ///<summary>Whether or not to wait for a response from the node. If not included in the payload, the integration will decide whether to wait or not. If set to `true`, note that the action can take a while if setting a value on an asleep battery device.</summary>
