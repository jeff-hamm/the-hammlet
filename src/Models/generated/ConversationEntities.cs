...
//   At: 2025-02-14T20:58:03.7893603-08:00
//
...
public partial class ConversationEntities : IEntityDomain<ConversationEntity>
{
    ...
    public ConversationEntity Entity(string entityId)
    {
        return (ConversationEntity)_haContext.Entity(entityId);
    }

    ///<summary>Home Assistant</summary>
    public ConversationEntity HomeAssistant => new(_haContext, "conversation.home_assistant");
    public ConversationIds Ids => new();
}