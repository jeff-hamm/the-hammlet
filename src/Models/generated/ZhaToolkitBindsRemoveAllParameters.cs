...
//   At: 2025-02-09T17:22:16.7328872-08:00
//
...
public partial record ZhaToolkitBindsRemoveAllParameters
{
    ...
    ///<summary>When provided, remove only bindings towards this device (Entity name, device name, or IEEE address of the binding destination) eg: 00:0d:6f:00:05:7d:2d:34</summary>
    [JsonPropertyName("command_data")]
    public string? CommandData { get; init; }

    ///<summary>When provided, remove only bindings for this endpoint or list of endpoints (single value or list. Example: 20 or [20, 30]) Otherwise: removes bindings for all endpoints</summary>
    [JsonPropertyName("endpoint")]
    public double? Endpoint { get; init; }

    ///<summary>When provided, remove only bindings for this cluster or list of clusters (single value or list. Example: 0x0200 or [0x200, 0x300]) Otherwise: removes bindings for all clusters</summary>
