...
//   At: 2025-02-09T17:22:16.7298563-08:00
//
...
public partial record ZhaToolkitBindIeeeParameters
{
    ...
    ///<summary>Binding target (Entity name, device name, or IEEE address of the node to execute command).  By default: coordinator eg: 00:0d:6f:00:05:7d:2d:34</summary>
    [JsonPropertyName("command_data")]
    public string? CommandData { get; init; }

    ///<summary>Target endpoint (when missing: all endpoints)</summary>
    [JsonPropertyName("endpoint")]
    public double? Endpoint { get; init; }

    ///<summary>Destination endpoint (when missing: first EP with matching cluster)</summary>
    [JsonPropertyName("dst_endpoint")]
    public double? DstEndpoint { get; init; }

    ///<summary>Target cluster (or all internally defined ones)</summary>
