...
//   At: 2025-02-03T13:48:14.4234461-08:00
//
...
public partial record ZhaToolkitRemoveFromGroupParameters
{
    ///<summary>Entity name, device name, or IEEE address of the node eg: 00:0d:6f:00:05:7d:2d:34</summary>
    [JsonPropertyName("ieee")]
    public string? Ieee { get; init; }

    ///<summary>endpoint to remove group from (or all EP if not set)</summary>
    [JsonPropertyName("endpoint")]
    public double? Endpoint { get; init; }

    ///<summary>Group id to remove eg: 2</summary>
    [JsonPropertyName("command_data")]
    public double? CommandData { get; init; }
