...
//   At: 2025-02-03T15:53:28.2063344-08:00
//
...
public partial record ZhaToolkitLeaveParameters
{
    ///<summary>Entity name, device name, or IEEE address of the node to leave the network eg: 00:0d:6f:00:05:7d:2d:34</summary>
    [JsonPropertyName("ieee")]
    public string? Ieee { get; init; }

    ///<summary>(Parent) Node (router) that removes the device of the node) eg: 00:0d:6f:00:05:7d:2d:34</summary>
