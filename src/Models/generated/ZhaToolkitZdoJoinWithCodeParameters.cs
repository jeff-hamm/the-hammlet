...
//   At: 2025-02-09T17:22:16.7695758-08:00
//
...
public partial record ZhaToolkitZdoJoinWithCodeParameters
{
    ///<summary>Entity name, device name, or IEEE address of the node to request rejoin eg: 00:0d:6f:00:05:7d:2d:34</summary>
    [JsonPropertyName("ieee")]
    public string? Ieee { get; init; }

    ///<summary>Node used to accept the rejoin (Entity name, device name, or IEEE address of the node) eg: 00:0d:6f:00:05:7d:2d:34</summary>
    [JsonPropertyName("command_data")]
    public string? CommandData { get; init; }

    ///<summary>The code the device needs to present eg: 01234567</summary>
