...
//   At: 2025-01-16T04:15:56.5413649-08:00
//
...
public partial record ZhaToolkitExecuteParameters
{
    ///<summary>Command name eg: scan_device</summary>
    ...
    ///<summary>data for the command (specific command. Example, second IEEE address for binding) eg: 00:0d:6f:00:05:7d:2d:34</summary>
    ...
    ///<summary>Command Id (zcl_cmd)</summary>
    [JsonPropertyName("cmd")]
    public double? Cmd { get; init; }
    ...
    public double? DstEndpoint { get; init; }
    ...
    ///<summary>Minimum report interval (seconds)</summary>
    [JsonPropertyName("min_interval")]
    public double? MinInterval { get; init; }

    ///<summary>Maximum report interval (seconds)</summary>
    [JsonPropertyName("max_interval")]
    public double? MaxInterval { get; init; }

    ///<summary>Minimum change before reporting</summary>
    [JsonPropertyName("reportable_change")]
    public double? ReportableChange { get; init; }

    ///<summary>Direction indicator, according to command</summary>
